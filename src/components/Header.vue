<template lang="pug">
  .flex
    <router-link to="/">
      h3.font-extrabold.text-3xl.text-green-700.tracking-tight.mt-6 Safebook
    </router-link>

    p.mx-auto.h-10
      <div class="h-12 mt-6 bg-transparent border rounded-lg dark:border-gray-700 lg:w-1/3 focus-within:border-primary focus-within:ring focus-within:ring-primary dark:focus-within:border-primary focus-within:ring-opacity-20">
