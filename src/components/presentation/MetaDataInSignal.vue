<template>
  <div>
    <h2>Signal</h2>
    <p>Dans le cas d'une fuite de la base de donnée de Signal, même si le contenu des messages est chiffré, on peut tout de même extraire beaucoup d'informations.</p>
    <ul class="list-disc list-inside">
      <li>Tous les nom d'utilisateur et leurs numéros de téléphone.</li>
      <li>Leurs amis et donc reconstruire le graphe social entre tous les utilisateurs.</li>
